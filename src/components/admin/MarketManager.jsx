...
// odds = starting odds shown before any bets are placed.
// They also apply to the very first bet placed on a market.
// Once bets exist, live odds are derived from the pool automatically.
...
export default function MarketManager({ game, onDone }) {
  ...
  const [markets, setMarkets] = useState(game.bet_markets ?? [])
